...
simulate(starting_position="fixed", sample_time=0.1, number_of_steps=1801, visualize=True, print_information=False, movement_method="dq_agent", movement_model=test_agent)
