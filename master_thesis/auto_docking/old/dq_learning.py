...
class Agent():
    def __init__(self, input_dims, n_actions, gamma=0.999, epsilon=1, lr=0.001, batch_size=128,
            max_mem_size=100_000, eps_end=0.01, eps_dec=0):
        self.gamma = gamma
        ...
        self.Q_eval = DeepQNetwork(lr, input_dims=input_dims,
                                    fc1_dims=64, fc2_dims=128, fc3_dims=256, fc4_dims=512, fc5_dims=256, fc6_dims=128, fc7_dims=64, n_actions=n_actions)
